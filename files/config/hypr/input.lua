...
-- Swap Alt <-> Super (Windows key) so the key positions match a Mac
-- keyboard: the key next to Ctrl acts as Alt/Option, and the next one
-- over acts as Super/Cmd. This also swaps Hyprland's own keybindings
